...
// as the DOM what size the canvas actually is in pixels 
...
const ogre = new Crawler(150, 25, 100, 150, "#bada55");
...
// Google: AABB collision detection 
...
function gameLoop () {
    ...
    if (detectHit()) {
        ...
        ogre.alive = false
        statusDisplay.innerText = "the hero has bravely slayed the ogre and survived!"
